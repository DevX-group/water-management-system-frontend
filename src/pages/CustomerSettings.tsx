                ...
                <div>
                  ...
                  >
                    <div className={cn(
                      ...
                      <span className="font-semibold text-xs sm:text-sm">{t('appearance.light')}</span>
                    </div>
                  </Label>
                ...
                <div>
                  ...
                  >
                    <div className={cn(
                      ...
                      <span className="font-semibold text-xs sm:text-sm">{t('appearance.dark')}</span>
                    </div>
                  </Label>
                ...
                <div>
                  ...
                  >
                    <div className={cn(
                      ...
                      <span className="font-semibold text-xs sm:text-sm">{t('appearance.system')}</span>
                    </div>
                  </Label>
                ...
                <div className={cn(
                  ...
                  <Label htmlFor="font-small" className="flex flex-1 cursor-pointer items-center justify-between">
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-muted-foreground hidden sm:block">{t('typography.smallDescription')}</p>
                    </div>
                ...
                <div className={cn(
                  ...
                  <Label htmlFor="font-medium" className="flex flex-1 cursor-pointer items-center justify-between">
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-muted-foreground hidden sm:block">{t('typography.mediumDescription')}</p>
                    </div>
                ...
                <div className={cn(
                  ...
                  <Label htmlFor="font-large" className="flex flex-1 cursor-pointer items-center justify-between">
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-muted-foreground hidden sm:block">{t('typography.largeDescription')}</p>
                    </div>

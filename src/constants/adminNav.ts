...
export const NAV_ITEMS: NavItem[] = [
  ...
  { icon: Gauge, label: 'Meter Reading', id: 'meter', roles: ['SUPER_ADMIN', 'METER_READER'] },
  { icon: Receipt, label: 'Billing', id: 'billing', roles: ['SUPER_ADMIN', 'CUSTOMER_HANDLER'] },
  { icon: CreditCard, label: 'Payments', id: 'payments', roles: ['SUPER_ADMIN', 'CUSTOMER_HANDLER'] },
  ...
  { icon: MessageSquare, label: 'Inquiry', id: 'inquiry', roles: ['SUPER_ADMIN', 'CUSTOMER_HANDLER'] },

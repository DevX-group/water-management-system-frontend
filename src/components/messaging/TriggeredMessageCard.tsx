...
export const TriggeredMessageCard: React.FC<TriggeredMessageCardProps> = ({ message, onEdit, onDelete }) => {
  ...
  return (
    <Card className="flex h-full min-h-[230px] flex-col">
      <CardHeader className="flex h-[72px] shrink-0 flex-row items-start justify-between space-y-0 overflow-hidden pb-2">
      ...
      <CardContent className="h-[90px] shrink-0 overflow-hidden">
      ...
      <CardFooter className="mt-auto flex h-[58px] shrink-0 items-center justify-between pt-2">

  ...
  return (
    ...
    >
      ...
      <div className="relative text-center text-primary-foreground max-w-md">
        ...
        <h2 className="text-2xl sm:text-3xl font-bold mb-3">{t('signup.sidePanelTitle', 'Account Holder')}</h2>
        <p className="text-primary-foreground/80 text-base leading-relaxed">
          {t('signup.sidePanelSubtitle', 'Create your account and start managing your water bills with ease. Join thousands of satisfied customers.')}
        </p>
      </div>
    </motion.div>
  );
